...
- 新增样本 `H2_AN202604161821261879_1.pdf`（重庆瑞法科技股份有限公司）与 `H2_AN202604161821261924_1.pdf`（江西瑞尔泰控制工程股份有限公司）表明，当前提取逻辑对新三板小体量公司和“经营情况分析”版式仍不够稳健。
- 小金额公司场景下，`净利润` 提取仍受历史金额阈值过滤影响，导致明明存在“归属于挂牌公司股东的净利润”与“五、净利润”行却被判定为缺失。
- 部分字段会误命中“经营情况分析/财务指标”中的百分比列，造成 `cash_and_equivalents`、`inventory`、`accounts_receivable` 等上年值被错误写成占比或同比数字。
- 对“归属于挂牌公司股东的净利润”“归属于挂牌公司股东的净资产”等新三板常见表述的兼容仍不完整。
- 资产负债表行项目在上年为空、只有当年数或夹带附注编号时，当前正则仍可能回退到错误的分析区文本。
