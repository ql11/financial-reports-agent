...
本项目最初基于模拟数据进行财报分析，但在分析英洛华2025年报时发现原系统存在严重缺陷：使用模拟数据无法发现真实异常、只做静态比率分析缺乏趋势和逻辑分析、风险评级严重错误（原系统：低风险4.8/10，实际：极高风险）。

改进后的系统基于真实财报数据，采用多维度分析算法，能够准确识别财报造假迹象。
...
### 关键发现
1. 业绩严重背离：收入下降3.12%，利润增长0.81%，现金流暴跌41.54%
2. 应收账款异常：增长12.57%，坏账准备减少
3. 存货异常：增长21.46%，跌价准备减少
4. 政府补助操纵：非经常性损益占比大幅上升
5. 产能利用率下降：总资产周转率偏低
